...
class Endpoints
{
    ...
    const SEEN_URL = 'https://www.instagram.com/stories/reel/seen/';
    const LOGIN_URL = 'https://www.instagram.com/accounts/login/ajax/';
    const TAF_URL = 'https://www.instagram.com/accounts/login/ajax/two_factor/';
    ...
    public static function getSeenUrl()
    {
        return static::SEEN_URL;
    }
